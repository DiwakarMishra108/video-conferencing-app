    ...
    return(
       <div className="myMeets-body">
         <div className="myMeets-body-nav">
            <ul>
                <li style ={pastMeets ? {borderBottom:"none"}: {borderBottom: "2px solid rgb(245,252,254)"}}></li>
                <li style ={!pastMeets ? {borderBottom:"none"}: {borderBottom: "2px solid rgb(245,252,254)"}}></li>
            </ul>
         </div>
          ...
          // upcomming meets
                                ...
                                <div class ="modal-dialog modal-dialog-centered" style={{width: '30vw'}}>
                                    <div class="modal-content">
                                      <div class="modal-header">
                                        <h5 class="modal-title" id="staticBackdropLabel">Edit Meet</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> 
                                      </div>
                                      <div className="modal-body">
                                        <div className="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput" placeholder="Name your meet" value={editRoomName} onChange={(e)=> setEditRoomName(e.target.value)}/>
                                            <label for="floatingInput">Meet Name</label>
                                        </div>

                                        <p style={{margin:"10px,0px,0px,0px", color:"rgb(2,34,58)",}}>MeetDate</p>
                                        <input type="date" class="form-control" value={editMeetDate} onChange={(e)=> setEditMeetDate(e.value.target)}/>
                                        <p style={{margin:"10px,0px,0px,0px", color:"rgb(2,34,58)",}}>MeetTime</p>
                                        <input type="time" class="form-control" value={editMeetTime} onChange={(e)=> setEditMeetTime(e.value.target)}/>


                                      </div>
                                      <div class="modal-footer">
                                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"Cancel></button>
                                      <button type="button" class="btn btn-primary" onClick ={()=>{socket.emit("update-meet-details",{roomId:meet._id,roomName:editRoomName,newMeetDate:editMeetDate,newMeetTime:editMeetTime,})}}/>
                                      </div>
                                    </div>
                                </div>
                                </div> 
            ...
            <div className="past-meet-content">
                ...
                myMeets.map((meet,i) =>{
                    ...
                    if (meet.meetDate==="nonoe" || meet.meetTime==="none" || meet.meetType === "instant"){
