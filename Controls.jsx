...
import ClouDownloadIcon from '@mui/icons-material/CloudDownload';
import StopCircleIcon from '@mui/icons-material/StoppCircle';
import RadioButtonCheckedIcon from '@mui/icons-material/RadioButtonChacked';
...
export default function Controls(props) {
    ...
    const {tracks, client, setStart, setInCall, screenTrack, setScreenTrack, participantsListOpen, setParticipantsListOpen} = props;
   ...
   const downloadVideo = async ()=>{
    if(recordedBlob){
        await download(recordedBlob, 'recorded-vide.webm');
